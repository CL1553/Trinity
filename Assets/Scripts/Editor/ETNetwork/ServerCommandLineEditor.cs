...
namespace Trinity.Editor
{
	...
	{
		private const string ConfigDir = @"ETServer/Config/StartConfig/";
		...
		[MenuItem("Trinity/ETNetwork/命令行配置")]
		...
		private void LoadConfig()
		{
			...
			{
				UnityEngine.Debug.LogError($"加载配置失败! {s2} \n {e}");
			}
		}
		...
		private void OnGUI()
		{
			...
			if (GUILayout.Button("启动"))
			{
				...
				if (startConfig == null)
				{
                    UnityEngine.Debug.LogError("没有配置Manager!");
					return;
				}
